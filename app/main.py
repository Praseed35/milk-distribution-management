...
from app.routers.customer_subscriptions import router as customer_subscription_router
from app.routers.delivery_exceptions import router as delivery_exception
...
app.include_router(delivery_exception)
